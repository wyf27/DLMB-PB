...
class VehicleDirectID(object):

    def __init__(self, root):

        self.images_dir = '/home/l603a/REID/wyf/data/VehicleID_V1.0/VehicleID_V1.0/image/'
        self.labelfile='/home/l603a/REID/wyf/data/VehicleID_V1.0/VehicleID_V1.0/train_test_split/'
        # self.images_dir = '/home/wyf/Work/VehicleID_V1.0/dealdarkdata/'
        #self.labelfile = '/home/weiying1/wyf/CamStyle-master/data/VehicleID/train_test_split/'
        self.train_path = self.images_dir
        self.gallery_path = self.images_dir
        self.query_path = self.images_dir
        self.train_file_path = self.labelfile+'train_list_direct.txt'
        self.gallery_file__path = self.labelfile+'gallery2400direct.txt'
        self.query_file__path = self.labelfile+'query2400_direct.txt'
        ...
        self.trainfrontnum,self.galleryfrontnum,self.queryfrontnum =0, 0, 0
        self.load()
